...
describe('ProductCategory e2e test', () => {
  ...
  it('should load ProductCategories', async () => {
    ...
    expect(await productCategoryComponentsPage.getTitle()).to.eq('apinessApp.productCategory.home.title');
  });
  ...
  it('should load create ProductCategory page', async () => {
    ...
    expect(await productCategoryUpdatePage.getPageTitle()).to.eq('apinessApp.productCategory.home.createOrEditLabel');
  ...
  it('should delete last ProductCategory', async () => {
    ...
    expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('apinessApp.productCategory.delete.question');
